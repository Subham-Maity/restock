...
import LargeViewCardsInfo from "@/components/product-t1/grid/card-info/large-view-cards-info";
...
import AdminActionCard from "@/components/product-t1/grid/admin-action/admin-action-card";

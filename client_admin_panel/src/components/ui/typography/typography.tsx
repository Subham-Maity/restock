...
export function ResponsiveHeading({ children, className }: TypographyProps) {
  return (
    <h1
      className={cn(
        "sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight leading-tight text-center",
        className,
      )}
    >
      {children}

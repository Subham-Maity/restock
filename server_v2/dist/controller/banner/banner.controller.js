...
const banner_model_1 = __importDefault(require("../../model/banner/banner.model"));
...
exports.updateBanner = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
        ...
        const updatedBanner = await banner_model_1.default.findByIdAndUpdate(id, req.body, { new: true });
        if (!updatedBanner) {

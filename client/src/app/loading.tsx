...
function Loading() {
    let placeholder=()=>{
                        ...
                        <div>
                            <h3 className="text-sm text-gray-700">
                                <div className="text-gray-800 dark:text-gray-300">
                                    ...
                                    </span><div className="w-36 lg:w-36 xl:w-48 2xl:w-64 h-10 rounded-l stretch"></div>
                                </div>
                            </h3>
        ...
        return (
            <div
                className="grid grid-cols-2 lg:p-8 gap-x-2 gap-y-10 mt-5 lg:mt-0 m-auto sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 xl:gap-x-2">
                    {temp}
            </div>
            );
    };
    return (
        <>
            <div className="fixed top-0 left-0 right-0 rounded-b-lg z-50 backdrop-blur-3xl">
                <nav className="bg-white/50 dark:bg-black/70 rounded-b-xl" data-headlessui-state="">
                    <div className="lg:mx-16 max-w-8xl px-5 sm:px-6 xl:px-8 py-2 sm:py-2 lg:py-2">
                        <div className="flex h-16 items-center justify-between lg:justify-start">
                            <div className="flex items-center">
                                <div className="flex space-x-2 mr-8"><a href="/"><div
                                                                                      // width="32" height="32"
                                                                                      // decoding="async" data-nimg="1"
                                                                                      // className="h-8 w-8"
                                                                                      // srcSet="/_next/image?url=https%3A%2F%2Fimg.freepik.com%2Ffree-vector%2Fmodern-desktop-compute-concept-illustration_114360-12156.jpg&amp;w=32&amp;q=75 1x, /_next/image?url=https%3A%2F%2Fimg.freepik.com%2Ffree-vector%2Fmodern-desktop-compute-concept-illustration_114360-12156.jpg&amp;w=64&amp;q=75 2x"
                                                                                      // src="/_next/image?url=https%3A%2F%2Fimg.freepik.com%2Ffree-vector%2Fmodern-desktop-compute-concept-illustration_114360-12156.jpg&amp;w=64&amp;q=75"
                                                                                      /></a>
                                </div>
                                <div className="hidden xl:block">
                                    <div className="flex items-center space-x-4"><a
                                        ...
                                        aria-current="page" href="/dod">
                                        <div className=" flex space-x-1  mr-2 ">
                                        </div>
                                    </a><a
                                        className="tflex items-center rounded-lg px-3 py-2 text-sm font-medium"
                                        href="/brand">
                                        <a
                                        ...
                                        href="/pc-components">
                                        <div className="dark:text-white flex space-x-1 text-black mr-2"><a
                                            className="stretch w-32 h-10 md:rounded-lg   text-white flex items-center rounded-lg px-3 py-2 text-sm font-medium"
                                            aria-current="page" href="/dod">
                                            <div className=" flex space-x-1  mr-2 ">
                                            </div>
                            ...
                            <div className="flex xl:hidden ">
                                <button
                                    ...
                                    data-headlessui-state=""><span className="sr-only">Open main menu</span>
            ...
            {/*Carousel*/}
            <div className="stretch rounded-b-2xl h-[230px] sm:h-[260px] md:h-[380px] lg:h-[480px] xl:h-[630px] 2xl:h-[780px]">
                                ...
                                <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md dark:bg-[#25293c] shadow-xl dark:shadow-[#292045] shadow-[#f3f4f6] ring-1 ring-black bg-white ring-opacity-5 focus:outline-none">
                                    <div className="py-1">
                                            ...
                                            <Menu.Item >
                                                    ...
                                                    <p className={"cursor-pointer dark:hover:bg-[#343756] hover:bg-[#f3f4f6] text-gray-800 dark:text-[#d9d8ff] dark:bg-[#25293c ] dark:hover:text-[#7f70ff] "}>
            ...
            <div className="flex w-full">
                <section aria-labelledby="products-heading" className="hidden lg:block pb-12 pt-6">
                    <h2 id="products-heading" className="sr-only">
                        Products
                    </h2>
                    <div className="flex flex-col gap-2">

                        <div className="stretch h-6 w-48 rounded-2xl">

            ...
            <div className="border-b dark:border-gray-400/25 border-gray-900/10 ">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-6">
                  ...
                  <div className="mt-2">
                    <div className="default-input">
                      <input id="title" className="default-input" />
                    </div>
                  </div>
                </div>
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2">
                    <select className="h-10 w-56 bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-xl focus:ring-indigo-500 focus:border-indigo-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500">

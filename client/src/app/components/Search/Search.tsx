        ...
        return (
            <div className="flex focus:outline-none bg-cyan-200">
                <div className="h-20 w-24 object-fill object-center">
                    <Image className="w-full h-full object-fill object-center" src={items.thumbnail} alt={items.category} height={100} width={80}/>
                </div>
                <span style={{ display: 'block', textAlign: 'left' }}>name: {items.title}</span>
            </div>
        )
    }
